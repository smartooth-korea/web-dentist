...
<c:if test="${userInfo.userType eq 'SU'}">
                                    <div class="regist">
										...
										<button type="button" class="btn btn-primary" data-toggle="modal" style="margin:0px; margin-top: 12px;" data-target="#exampleModal">등록2</button>
                                    </div>
                                    <div class="delete">
...
<!-- 						</select> -->
<!-- 					</div> -->
				<input type="hidden" id="userType" name="userType" value="DL">
				<div class="wrap-div">
					<div class="div-td-left">
					<font color="red">＊</font>
						연락처 : &nbsp;
...
$(document).ready(function(){
	...
	$("#grid").jqGrid({
		url : "/admin/user/ajaxSelectDealerList",
		datatype : "json",
		styleUI: 'Foundation',
		...
		loadonce:true,
		height : 469, // 그리드의 높이를 해상도 변경에 따라 변하도록 변경해줘야함
