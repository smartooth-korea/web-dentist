...
<div id="insertModal" class="modal">
	...
	<div style="height:30px;"></div>
		<form method="post" id="frm">
				...
				<input type="hidden" id="userType" name="userType" value="ME">
				<div class="wrap-div">
					<div class="div-td-left">
					<font color="red">＊</font>
						연락처 : &nbsp;
...
// 		}else {
// 			jQuery("#grid").jqGrid( 'setGridHeight', 728);
...
// 		jQuery("#grid").setGridParam({rowNum:25});		
	...
	$("#grid").jqGrid({
		url : "/admin/user/ajaxSelectMeasurerUserList",
		datatype : "json",
		styleUI: 'Foundation',
