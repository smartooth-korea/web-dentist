                    ...
                    <div class="row">
						<div class="col-xl-12">
                            <div class="card shadow mb-4 gridHeight">
								<form name="frmExcel" id="frmExcel" action="/admin/user/insertXlsxUsers.do" method="post" enctype="multipart/form-data">                                
								<div class="menu-title">명단 일괄 등록 - 파일 확장자 : 엑셀 (xls, xlsx)</div>
								<div class="top-space">
									...
									<button type="submit" class="btn btn-info btn-fill button" id="registExcel" value="등록" onclick="">
										등록
									</button>
								</div>
							</form>
							<div class="commonHeight30"></div>
							<form name="frm" id="frm" action="/admin/user/insertDepartmentUserInfo.do" method="post">                                
