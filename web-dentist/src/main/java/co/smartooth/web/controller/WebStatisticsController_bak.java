...
// */
//@Controller
//public class WebStatisticsController_bak {
//
//	@Value("${loginUrl}")
...
//	public String diagnosis1(HttpServletRequest request, HttpSession session, Model model) throws Exception {
//
//		// 세션 값
...
////						// GA1 그룹핑
////						for(int i=0; i<list.size(); i++) {
////							if(list.get(i).equals("A01")) {
////								key += 1;
////							}else if(list.get(i).equals("A02")){
////								key += 10;
////							}else if(list.get(i).equals("A04")){
////								key += 100;
////							}
////							
////						}
...
////						switch (key) {
////							case 1:
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A01");
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("GA1") + "<br/>";
////								break;
////							case 10:
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A02");
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("GA1") + "<br/>";
////								break;
////							case 100:
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A04");
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("GA1") + "<br/>";
////								break;
////							case 11:
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A01");
...
////						// A03, A05, A06, A07 
////						for(int i=0; i<list.size(); i++) {
////							if(list.get(i).equals("A03")) {
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A03") + "<br/>";
////							}else if(list.get(i).equals("A05")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A05") + "<br/>";
////							}else if(list.get(i).equals("A06")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A06") + "<br/>";
////							}else if(list.get(i).equals("A07")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A07") + "<br/>";
////							}
////						}
////							
////
...
////						key = 0; 
////						for(int i=0; i<list.size(); i++) {
////							if(list.get(i).equals("A08")) {
////								key += 1;
////							}else if(list.get(i).equals("A09")){
////								key += 10;
////							}
////							
////						}
...
////						switch (key) {
////						case 1:
////							diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A08");
////							diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("GA2") + "<br/>";
////							break;
////						case 10:
////							diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A09");
////							diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("GA2") + "<br/>";
////							break;
////						case 11:
////							diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A08");
...
////						// A10~A22
////						for(int i=0; i<list.size(); i++) {
////							if(list.get(i).equals("A10")) {
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A10") + "<br/>";
////							}else if(list.get(i).equals("A11")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A11") + "<br/>";
////							}else if(list.get(i).equals("A12")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A12") + "<br/>";
////							}else if(list.get(i).equals("A13")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A13") + "<br/>";
////							}else if(list.get(i).equals("A14")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A14") + "<br/>";
////							}else if(list.get(i).equals("A15")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A15") + "<br/>";
////							}else if(list.get(i).equals("A16")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A16") + "<br/>";
////							}else if(list.get(i).equals("A17")) {
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A17") + "<br/>";
////							}else if(list.get(i).equals("A18")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A18") + "<br/>";
////							}else if(list.get(i).equals("A19")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A19") + "<br/>";
////							}else if(list.get(i).equals("A20")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A20") + "<br/>";
////							}else if(list.get(i).equals("A21")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A21") + "<br/>";
////							}else if(list.get(i).equals("A22")){
////								diagDescript += "&nbsp;" + webDiagnosisService.selectDiagDescript("A22") + "<br/>";
////							}
////						}
//					
//					
...
//				webTeethMeasureVO.setLimit(limit);
//				// 측정일
//				measureDt = paramMap.get("measureDt");
//				
//				// 측정일 목록 조회
//				measureDtList = webTeethService.selectUserMeasureDtList(webTeethMeasureVO);
//				
...
//					
//					
//						// 진단 코드를 누르지 않았으면 카운팅이 없으므로 이상없음 처리
//						if (isDiagCnt == 0) {
...
//						diagCdTitleArray = userDiagCd.split("\\|");
//						for (int i = 0; i < diagCdTitleArray.length; i++) {
//							String diagTitle = webTeethService.selectDiagTitle(diagCdTitleArray[i]);
//							if (diagTitle != null) {
//								webTeethMeasureVO.setDiagTitle(diagTitle);
//								break;
//							}
