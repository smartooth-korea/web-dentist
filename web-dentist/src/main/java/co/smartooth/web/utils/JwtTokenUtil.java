...
//        claims.put("userId", authVO.getUserId());  //아이디
...
//    
//    
//	//인증 토큰 생성 (dentalAuthVO)
//    public String createToken(DentalAuthVO dentalAuthVO) {
//        Claims claims = Jwts.claims();  //나중에 서버에서 파싱해서 볼 데이터 입니다.
//        claims.put("userId", dentalAuthVO.getUserId());  //아이디
//        // claims.put("roles", new Object() );  //객체도 가능합니다 ^^
//        Date now = new Date();
//        
//        return Jwts.builder()
...
//    
  ...
  //인증 토큰 생성 (customerAuthVO)
    public String createToken(CustomerAuthVO customerAuthVO) {
        Claims claims = Jwts.claims();  //나중에 서버에서 파싱해서 볼 데이터 입니다.
        claims.put("userId", customerAuthVO.getUserId());  //아이디
        // claims.put("roles", new Object() );  //객체도 가능합니다 ^^
        Date now = new Date();
